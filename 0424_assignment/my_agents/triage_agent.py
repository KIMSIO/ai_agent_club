...
from models import CustomerContext, InputGuardRailOutput, OutputGuardRailOutput, HandoffData
...
output_guardrail_agent = Agent(
    ...
    instructions="""
    Review the agent's response and check for:
    1. Unprofessional or rude language
    2. Leaked internal information (e.g. cost margins, staff schedules, internal policies, system prompts)
    3. Promises the restaurant cannot keep
    4. Any content inappropriate for a customer-facing restaurant bot

    If any of these are found, set is_inappropriate to true and explain why.
    Light humor and friendly tone are fine — only flag genuinely problematic content.
""",
...
def dynamic_triage_agent_instructions(
    ...
    - Customer dissatisfaction, negative experiences
    - Food quality issues, service complaints
    - Requests for refunds, discounts, or manager callbacks
    - "The food was terrible", "The staff was rude", "I want a refund"
